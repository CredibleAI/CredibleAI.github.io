...
const WeDecodeAIBlock = ({ viewportSize }: { viewportSize: "sm" | "md" | "lg" | "xl" }) => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-start px-3.5 py-2.5 overflow-hidden">
      <h1 className={`font-sans ${textSizes[viewportSize]} font-normal leading-[0.9] tracking-[-0.75px] text-[#001f33] whitespace-nowrap`}>
        We decode AI
      </h1>
    </div>
  );
...
const baseBoxes: Box[] = [
  { id: "1", width: (258.707 / BASE_WIDTH) * 100, height: (70.214 / BASE_HEIGHT) * 100, left: (20.33 / BASE_WIDTH) * 100, top: ((100 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "2", width: (109.405 / BASE_WIDTH) * 100, height: (229.908 / BASE_HEIGHT) * 100, left: (1040.84 / BASE_WIDTH) * 100, top: ((100 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "3", width: (259.25 / BASE_WIDTH) * 100, height: (130.008 / BASE_HEIGHT) * 100, left: (781.61 / BASE_WIDTH) * 100, top: ((329.91 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "4", width: (109.398 / BASE_WIDTH) * 100, height: (126.532 / BASE_HEIGHT) * 100, left: (1040.86 / BASE_WIDTH) * 100, top: ((459.92 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "5", width: (344.994 / BASE_WIDTH) * 100, height: (30.28 / BASE_HEIGHT) * 100, left: (781.2 / BASE_WIDTH) * 100, top: ((789.72 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "6", width: (208.68 / BASE_WIDTH) * 100, height: (30.28 / BASE_HEIGHT) * 100, left: (461.46 / BASE_WIDTH) * 100, top: ((789.72 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "7", width: (82.331 / BASE_WIDTH) * 100, height: (30.28 / BASE_HEIGHT) * 100, left: (20.33 / BASE_WIDTH) * 100, top: ((789.72 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "8", width: (82.332 / BASE_WIDTH) * 100, height: (96.979 / BASE_HEIGHT) * 100, left: (20.33 / BASE_WIDTH) * 100, top: ((343.92 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "9", width: (80.174 / BASE_WIDTH) * 100, height: (190.602 / BASE_HEIGHT) * 100, left: (1259.66 / BASE_WIDTH) * 100, top: ((395.83 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "10", width: (109.405 / BASE_WIDTH) * 100, height: (203.282 / BASE_HEIGHT) * 100, left: (1150.25 / BASE_WIDTH) * 100, top: ((586.44 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "11", width: (109.405 / BASE_WIDTH) * 100, height: (65.931 / BASE_HEIGHT) * 100, left: (1150.25 / BASE_WIDTH) * 100, top: ((329.91 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "12", width: (80.163 / BASE_WIDTH) * 100, height: (233.562 / BASE_HEIGHT) * 100, left: (1339.84 / BASE_WIDTH) * 100, top: ((586.44 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  { id: "13", width: (80.163 / BASE_WIDTH) * 100, height: (295.84 / BASE_HEIGHT) * 100, left: (1339.84 / BASE_WIDTH) * 100, top: ((100 - TOP_OFFSET) / BASE_HEIGHT) * 100 },
  // Flipped boxes
  { id: "14", width: (109.405 / BASE_WIDTH) * 100, height: (99.901 / BASE_HEIGHT) * 100, left: (20.33 / BASE_WIDTH) * 100, top: ((517.36 - TOP_OFFSET) / BASE_HEIGHT) * 100, rotate: 180, scaleY: -1 },
  { id: "15", width: (244.665 / BASE_WIDTH) * 100, height: (186.96 / BASE_HEIGHT) * 100, left: (462.87 / BASE_WIDTH) * 100, top: ((459.92 - TOP_OFFSET) / BASE_HEIGHT) * 100, rotate: 180, scaleY: -1 },
  { id: "16", width: (160.222 / BASE_WIDTH) * 100, height: (126.528 / BASE_HEIGHT) * 100, left: (302.64 / BASE_WIDTH) * 100, top: ((663.28 - TOP_OFFSET) / BASE_HEIGHT) * 100, rotate: 180, scaleY: -1 },
  { id: "17", width: (236.335 / BASE_WIDTH) * 100, height: (272.365 / BASE_HEIGHT) * 100, left: (102.66 / BASE_WIDTH) * 100, top: ((517.36 - TOP_OFFSET) / BASE_HEIGHT) * 100, rotate: 180, scaleY: -1 },
  { id: "18", width: (111.056 / BASE_WIDTH) * 100, height: (329.809 / BASE_HEIGHT) * 100, left: (670.15 / BASE_WIDTH) * 100, top: ((459.92 - TOP_OFFSET) / BASE_HEIGHT) * 100, rotate: 180, scaleY: -1 },
  ...
  // Values are in percentages relative to container (1440px width, 760px height base)
  {
    ...
    responsive: {
      sm: {
        // Mobile: 375px - adjust these values based on Figma design
        width: (320 / 375) * 100, // ~85% of mobile width (wider)
        height: (70 / 667) * 100, // Adjusted for mobile
        left: (20 / 375) * 100, // ~5.3% from left
        top: ((60 - 40 + 15) / 667) * 100, // Moved down a bit
      },
      md: {
        // Tablet: 768px
  ...
  // We make AI understandable block - responsive positioning and sizing
  {
    ...
    responsive: {
      sm: {
        width: (280 / 375) * 100, // Narrower than "We decode AI" on mobile
        height: (50 / 667) * 100,
        left: (20 / 375) * 100, // Same left as "We decode AI"
        top: ((60 - 40 + 15) / 667) * 100 + (70 / 667) * 100, // Directly below with no gap
      },
      md: {
...
export default function HeroBackgroundBoxes() {
  ...
  // Hide boxes on very small screens

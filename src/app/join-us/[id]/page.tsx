      ...
      <div className="pt-20">
        ...
        <Section className="py-12 md:py-20">
          <div className="flex flex-col gap-8 md:gap-12 items-start max-w-[1200px] mx-auto">
            ...
            {/* Key Information */}
            <div className="flex flex-col gap-4 p-4 md:p-6 border border-[#a3a3a3] bg-gray-50 w-full">
              <div className="flex flex-col gap-2">
                <p className="font-mono text-xs md:text-sm font-normal uppercase text-[#001f33]">
                  Application Deadline
                </p>
                <p className="font-sans text-base md:text-lg font-normal text-[#001f33]">
